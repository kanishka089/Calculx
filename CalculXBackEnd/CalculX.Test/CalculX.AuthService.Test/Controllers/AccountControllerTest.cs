...
using CalculX.AuthService.Controllers;
...
public class AccountControllerTest
{
    ...
    {
        // Arrange
        var model = new LoginViewModel { Username = "test@example.com", Password = "Password123!" };
    ...
    {
        // Arrange
        var model = new LoginViewModel { Username = "test@example.com", Password = "WrongPassword!" };
